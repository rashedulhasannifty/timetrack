      ...
      <header className="grid items-start gap-x-16 gap-y-10 py-16 lg:grid-cols-[minmax(0,1fr)_24rem] lg:py-24">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            ...
            <a
              href={DOWNLOAD_URL}
              className="border-separator bg-surface-raised hover:border-text-secondary rounded-full border px-5 py-2.5 text-[0.9375rem] font-semibold transition-colors"
            >
              Download for Mac
            </a>
            <a
