...
export async function updateSettingsAction(
  ...
  const parsed = UpdateSettingsSchema.safeParse({
    ...
    autoApproveTimesheets: formData.get('autoApproveTimesheets') === 'on',
    autoApproveAfterDays: Number(formData.get('autoApproveAfterDays')),
    autoApproveMaxHours: Number(formData.get('autoApproveMaxHours')),
